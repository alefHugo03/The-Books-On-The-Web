...
<div class="cabecalho header-cima">
    <div class="empresa">
        <a href="/The-Books-On-The-Web/public/index.php" class="nome-empresa">
            <h1>The Books<br> On The Web</h1>
        </a>
        <a href="/The-Books-On-The-Web/public/index.php" class="nome-empresa"><img src="styles/img/favicon.svg" alt="imagem logo" class="imagem-empresa"></a>
    </div>

    <div class="pesquisa">
        <form action="/The-Books-On-The-Web/public/templates/biblioteca/pesquisa.php" id="pesquisar" class="pesquisar" method="get">
...
<div class="cabecalho header-baixo"> 
    <nav class="opcoes"> 
        <a href="/The-Books-On-The-Web/public/index.php" class="item-menu">Home</a>
        <a href="/The-Books-On-The-Web/public/templates/biblioteca/resumo.html" class="item-menu">Sobre</a>
