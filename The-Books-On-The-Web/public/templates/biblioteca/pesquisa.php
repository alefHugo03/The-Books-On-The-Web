...
$sql = "SELECT livro.*, 
        ...
        FROM livro 
        -- Correção: id_livro e id_categoria (minúsculos e simples)
        LEFT JOIN temas ON livro.id_livro = temas.id_livro
        LEFT JOIN categoria ON temas.id_categoria = categoria.id_categoria
