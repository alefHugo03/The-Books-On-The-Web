...
$sql = "SELECT l.*, GROUP_CONCAT(c.nome_categoria SEPARATOR ', ') as categorias
          FROM livro l 
          ...
          GROUP BY l.id_livro
          ORDER BY MAX(f.data_favoritado) DESC";
            ...
            <div class="lista-livros">
                ...
                if ($resultado && mysqli_num_rows($resultado) > 0) {
                    while ($livro = mysqli_fetch_assoc($resultado)) {
                        ...
                        echo '<span class="categoria-tag">' . htmlspecialchars($livro['categorias']) . '</span>';
                        echo '</div>';
                        echo '</div>';
                        echo '</a>';
                    }
