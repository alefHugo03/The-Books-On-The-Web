...
--
-- Host: 127.0.0.1
-- Tempo de geração: 23/11/2025 às 18:41
...
INSERT INTO `escritor` (`id_livro`, `id_autor`) VALUES
(12, 3),
(13, 2),
(14, 1),
(15, 4),
...
(13, 6, 31, '2025-11-20 20:17:52'),
(15, 2, 31, '2025-11-23 12:08:14');
...
INSERT INTO `temas` (`id_livro`, `id_categoria`) VALUES
(12, 2),
(13, 2),
(14, 4),
(15, 3),
...
(6, NULL, '2007-10-08', 'Aline Cordeiro ', 'alinecordeiro725@gmail.com', '$2y$10$C0QSbl4aXXobMyEYpQPPZeziKHQjZIBwx2BRb./.AepBAC1SYKil6', '134.567.902-11', 'cliente', 0),
(8, NULL, '2000-03-12', 'teste', 'teste@gmail.com', '$2y$10$8Lfb9L8Qzjk4anNxlMVvR.8gOrVBeqWRDkwqmVzYcDm3JDTShJvDa', '123.456.123-45', 'admin', 1);
...
ALTER TABLE `escritor`
  ...
  ADD KEY `fk_escritor_autor` (`id_autor`);
...
ALTER TABLE `temas`
  ...
  ADD KEY `fk_temas_categoria` (`id_categoria`);
...
--
ALTER TABLE `livro`
  MODIFY `id_livro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `escritor`
  ADD CONSTRAINT `fk_escritor_autor` FOREIGN KEY (`id_autor`) REFERENCES `autor` (`id_autor`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_escritor_livro` FOREIGN KEY (`id_livro`) REFERENCES `livro` (`id_livro`) ON DELETE CASCADE;
...
--
ALTER TABLE `livro`
  ADD CONSTRAINT `fk_livro_editora` FOREIGN KEY (`id_editora`) REFERENCES `editora` (`id_editora`) ON DELETE SET NULL;

--
-- Restrições para tabelas `temas`
--
ALTER TABLE `temas`
  ADD CONSTRAINT `fk_temas_categoria` FOREIGN KEY (`id_categoria`) REFERENCES `categoria` (`id_categoria`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_temas_livro` FOREIGN KEY (`id_livro`) REFERENCES `livro` (`id_livro`) ON DELETE CASCADE;
COMMIT;
